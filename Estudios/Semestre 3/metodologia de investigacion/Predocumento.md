...
Descomponiendo los problemas sobre el problema Pude encontrar 4 sectores que deben estar contribuyendo a esto :

**Campo Psicológico**: dividido en dos en *el algoritmo de Búsqueda y Recompensa* que es un sistema que siguen las maquinas tragaperras donde juegan con tu incertidumbre en este caso por encontrar un mejor contenido que el anterior que viste. Luego *la atrofia a la frustración* donde se puede ver que los jóvenes no saben sobrellevar los momentos de mayor ajetreo para ellos .

**Campo Familia/Padres** : Dividido en 3 secciones 
- Sobreprotección --. Que iría por el lado de que los padres protegen a sus de sufrir ciertos estresores como la frustración de que te salga algo mal y en cambio ellos hacen esos escenarios donde no desempeñan bien.
- Herramienta Sin Control -. La falta de control sobre el uso de dispositivos inteligentes , restricciones para los jóvenes para poder mantenerlos en ese estado donde puedes disfrutar de sus funcionalidades  y tener esos limites saludables para que sean conscientes de el uso de pantallas. 
-  Falta de Concientización Digital -. Tal cual los padres les toco vivir esta época digital y pues algunos no son muy conscientes del problema y sus posibles efectos  .

**Tecnologia**: 
- Notificaciones -. Realmente las veces que somos interrumpidos igual provoca la necesidad de estar conectados en todas partes y todo el tiempo.
- Contenido Rapido -. La creacion de contenido en grandes cantidades todos los dias en formato corto provoca esa necesidad de estar al dia en novedades o informacion.
- Herramientas Asequibles -. Realmente cada vez es mas sencillo todo y es por eso que aveces el contenido tiene diferencias brutales de calidad por la facilidad de hacerlo sin ser experto.

**Social** :

- Productividad Valorada -. Se esta creando la idea de que hay que aprovechar cualquier momento para poder realizar tus trabajos , llevar a acabo proyectos o X cosas y esto ayuda a crear esa necesidad de hacer algo útil con su tiempo mientras se encuentran algo que quizá no sea ocio o sientan que malgastan el tiempo.
- Incomodidad Mal Vista -. La incomodidad esta siendo mal vista lo que provoca que se busque una manera de evadir o esquivarla o postergarla para mas después en vez de afrontarla.
- FOMO -. Atreves de muchas actualizaciones por la novedades se crea la sensación de que nos perdemos de algo que los otros saben provocando mas tentación al individuo.

# Formulación del Problema

¿De que manera la falta de regulación de los padres sobre el uso que le dan a sus hijos el celular puede afectar a la capacidad de estar tranquilos con el yo mismo?
